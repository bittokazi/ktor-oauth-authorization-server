...
class DefaultAuthorizationCodeTokenGenerator(
    ...
    override suspend fun generateTokens(
        ...
        val code = params["code"] ?: return Result.Failure(
            mapOf(
        ...
        val redirectUri = params["redirect_uri"] ?: return Result.Failure(mapOf(
        ...
        if (client.clientType == "confidential") {
            ...
            val codeVerifier = params["code_verifier"] ?: return Result.Failure(mapOf(
