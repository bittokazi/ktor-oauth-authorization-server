...
class DefaultTokenRevokeServiceTest {
    ...
    @Test
    fun `revoke() returns success when revoking valid access token`() =
        runTest {
    ...
    @Test
    fun `revoke() returns success when revoking valid refresh token`() =
        runTest {
    ...
    @Test
    fun `revoke() returns success when revoking both access and refresh token`() =
        runTest {
    ...
    @Test
    fun `revoke() returns success with empty token list when token is not found`() =
        runTest {
    ...
    @Test
    fun `revoke() does not call revokeAccessToken when access token is not found`() =
        runTest {
    ...
    @Test
    fun `revoke() does not call revokeRefreshToken when refresh token is not found`() =
        runTest {
    ...
    @Test
    fun `revoke() completes successfully even if token is already revoked`() =
        runTest {
    ...
    @Test
    fun `revoke() completes successfully even if token is expired`() =
        runTest {
    ...
    @Test
    fun `revoke() returns success when revoking token with multiple scopes`() =
        runTest {
