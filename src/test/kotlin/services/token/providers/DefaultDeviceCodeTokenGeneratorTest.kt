...
class DefaultDeviceCodeTokenGeneratorTest {
    ...
    fun `generateTokens() returns failure when client_id is missing`() = runTest {
        val actual = deviceCodeTokenGenerator.generateTokens(
            params = mapOf(
    ...
    @Test
    fun `generateTokens() returns failure when device_code is missing`() = runTest {
        val actual = deviceCodeTokenGenerator.generateTokens(
            params = mapOf(
                "client_id" to "some_client_id",
                "client_secret" to "some_secret"
    ...
    @Test
    fun `generateTokens() returns failure when device_code is invalid`() = runTest {
        val clientIdentifier = UUID.randomUUID()
        val clientId = UUID.randomUUID()
    ...
    @Test
    fun `generateTokens() returns failure when device_code is expired`() = runTest {
        val clientIdentifier = UUID.randomUUID()
        val clientId = UUID.randomUUID()
    ...
    @Test
    fun `generateTokens() returns failure when authorization is pending`() = runTest {
        val clientIdentifier = UUID.randomUUID()
        val clientId = UUID.randomUUID()
    ...
    @Test
    fun `generateTokens() returns success with access_token when all parameters are valid`() = runTest {
        val clientIdentifier = UUID.randomUUID()
        val clientId = UUID.randomUUID()
        val userId = "user_1"
    ...
    @Test
    fun `generateTokens() returns success with refresh_token when grant type is included`() = runTest {
        val clientIdentifier = UUID.randomUUID()
        val clientId = UUID.randomUUID()
        val userId = "user_1"
        val accessToken = "generated_access_token"
    ...
    @Test
    fun `generateTokens() returns success with id_token when openid scope is included`() = runTest {
        val clientIdentifier = UUID.randomUUID()
        val clientId = UUID.randomUUID()
        val userId = "user_1"
        val accessToken = "generated_access_token"
        ...
        val oauthClientDto = OAuthClientDTO(
            id = clientIdentifier,
            clientName = "Test Client",
            clientId = clientId.toString(),
            clientSecret = "valid_client_secret",
    ...
    @Test
    fun `generateTokens() returns success with all tokens when refresh_token grant and openid scope are included`() = runTest {
        val clientIdentifier = UUID.randomUUID()
        val clientId = UUID.randomUUID()
        val userId = "user_1"
        val accessToken = "generated_access_token"
