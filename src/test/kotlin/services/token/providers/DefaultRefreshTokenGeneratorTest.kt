...
class DefaultRefreshTokenGeneratorTest {
    ...
    @Test
    fun `generateTokens() returns token successfully for public client`() =
        runTest {
            val clientIdentifier = UUID.randomUUID()
            val clientId = UUID.randomUUID()
            val accessToken = "generated_access_token"
    ...
    @Test
    fun `generateTokens() returns token successfully with id_token when openid scope is present`() =
        runTest {
            val clientIdentifier = UUID.randomUUID()
            val clientId = UUID.randomUUID()
            val client =
    ...
    @Test
    fun `generateTokens() returns failure when refresh_token is missing`() =
        runTest {
            val actual =
                refreshTokenGenerator.generateTokens(
                    params =
    ...
    @Test
    fun `generateTokens() returns failure when refresh_token is invalid`() =
        runTest {
            val clientIdentifier = UUID.randomUUID()
            val clientId = UUID.randomUUID()
    ...
    @Test
    fun `generateTokens() returns failure when client_id does not match refresh_token client_id`() =
        runTest {
            val clientIdentifier = UUID.randomUUID()
    ...
    @Test
    fun `generateTokens() returns failure when refresh_token is expired`() =
        runTest {
            val clientIdentifier = UUID.randomUUID()
            val clientId = UUID.randomUUID()
    ...
    @Test
    fun `generateTokens() returns failure when refresh_token is revoked`() =
        runTest {
            val clientIdentifier = UUID.randomUUID()
            val clientId = UUID.randomUUID()
